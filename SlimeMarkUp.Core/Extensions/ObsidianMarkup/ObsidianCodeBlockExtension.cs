...
namespace SlimeMarkUp.Core.Extensions.ObsidianMarkup
{
    ...
    /// </summary>
    /// <remarks>
    /// A code block starts and ends with a line containing exactly <c>```</c>.
    /// All lines between the opening and closing fences are treated as raw code
    /// and preserved without further parsing.
    /// </remarks>
    public class ObsidianCodeBlockExtension : IBlockMarkupExtension
    {
        /// <summary>
